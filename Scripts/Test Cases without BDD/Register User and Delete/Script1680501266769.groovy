...
WebUI.callTestCase(findTestCase('Test Cases without BDD/Reusable Test Cases/Register User'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_Automation Exercise/a_Delete Account'))

WebUI.verifyElementText(findTestObject('Page_Automation Exercise - Account Created/b_Account Deleted'), 'ACCOUNT DELETED!')
