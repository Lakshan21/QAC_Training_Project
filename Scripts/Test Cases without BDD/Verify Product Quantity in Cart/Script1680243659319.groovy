...
WebUI.verifyElementPresent(findTestObject('Page_Automation Exercise - Product Details/div_AddedYour product has been added to car_c29c8b'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Automation Exercise - Checkout/tr_Blue TopWomen  TopsRs. 5004Rs. 2000'), 
    0)
