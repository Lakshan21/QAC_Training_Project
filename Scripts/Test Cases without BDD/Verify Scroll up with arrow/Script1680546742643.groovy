...
WebUI.scrollToElement(findTestObject('Page_Automation Exercise/h2_Subscription'), 0)
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Automation Exercise/h2_Full-Fledged practice website for Automa_49aaf4'), 
