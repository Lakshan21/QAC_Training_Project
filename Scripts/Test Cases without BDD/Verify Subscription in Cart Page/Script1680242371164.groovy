...
WebUI.setText(findTestObject('Object Repository/Page_Automation Exercise - Checkout/input_Subscription_susbscribe_email'), 
    'johndoe@hotmail.com')

WebUI.click(findTestObject('Object Repository/Page_Automation Exercise - Checkout/button_Subscription_subscribe'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Automation Exercise - Checkout/div_You have been successfully subscribed'), 
